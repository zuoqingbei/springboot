...
public class CommonInterfaceExcController extends BaseController {
    ...
    public PublicResult<Page<CommonInterfaceExc>> list(CommonInterfaceExc entity,@RequestParam(value="pageNum",required = false,defaultValue="1") Integer pageNum,
			@RequestParam(value="pageSize",required = false,defaultValue="10") Integer pageSize,HttpServletRequest request) {
		try {
			Page<CommonInterfaceExc> page=iCommonInterfaceExcService.pageList(this, request, entity, pageNum, pageSize);
