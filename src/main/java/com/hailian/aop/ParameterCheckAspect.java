...
import com.hailian.utils.ComUtil;
import com.hailian.utils.StringUtil;
...
public class ParameterCheckAspect {
     ...
     * 防止XSS攻击
     */
	@Pointcut("execution(public * com.hailian.controller.*.*(..))")
    public void preventXSS() {
    }
    /**
     * Log注解
     */
    @Pointcut("@annotation( com.hailian.annotation.Log)")
    public void recordLog(){
    }
    /**
     * 验证参数
     */
   /* @Pointcut("@annotation(com.hailian.aop.ValidationParam)")
